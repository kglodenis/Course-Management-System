...
public class DbUtils {
    ...
    public static Connection connectToDb() {
        ...
        try {
            ...
            String DB_URL = "jdbc:mysql://localhost/CourseManagementSystem";
            String USER = "root";
            String PASS = "";
    ...
    public static void updateField(String dsName, String dbColName, String value, int userId) {
        Connection connection = connectToDb();
        String sql = "UPDATE "+dsName+" SET " + dbColName + " = ? WHERE id = ?";
        try {
